...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1cc9cc5bca2ab64f9ccebb457a32c94c) *)
(*
...
let setup_t =
  {
            ...
            [
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("xen-gnt", None);
                           FindlibPackage ("xenstore", None);
                           FindlibPackage ("xenstore.client", None);
                           FindlibPackage ("xenstore_transport", None);
                           FindlibPackage ("xenstore_transport.lwt", None);
                           FindlibPackage ("lwt", None);
                           FindlibPackage ("mirage-types.lwt", None);
                           FindlibPackage ("vchan", None);
                           FindlibPackage ("testvmlib", None);
                           FindlibPackage ("xen-api-client", None);
                           FindlibPackage ("xen-api-client.lwt", None)
                        ];
                   ...
                   {exec_custom = false; exec_main_is = "quicktest.ml"})
            ];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "%a\240\225Lr\143\158\251E\244F\018\025\b<";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
